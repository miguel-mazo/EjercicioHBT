...
import com.hbt.semillero.dto.MensajesDTO;
...
import com.hbt.semillero.entidades.Mensajes;
...
public class ConsultasEJB implements IConsultasEJBLocal {
	...
	public String crearMensaje(MensajesDTO mensaje) {
		
		Mensajes mensajeNew = new Mensajes();
		mensajeNew.setMensajeId(mensaje.getMensajeId());
		mensajeNew.setMensaje(mensaje.getMensaje());
		
		em.persist(mensajeNew);
		
		return "Mensaje creado con éxito";
